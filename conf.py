...
BLOG_AUTHOR = "Adam Saleh"  # (translatable)
BLOG_TITLE = "Adam Saleh"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://asaleh.net/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://asaleh.net/"
BLOG_EMAIL = "adam@asaleh.net"
BLOG_DESCRIPTION = "I am a programmer, working at Red Hat, building CI/CD, fighting Jenkins. Sometimes I write about programming."  # (translatable)
